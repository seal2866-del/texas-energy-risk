...
const POSTS = [
  { slug: "ercot-ancillary-services-guide",   title: "ERCOT Ancillary Services: What They Are and Why They Matter for Texas Operations", date: "June 2026", category: "ERCOT Intelligence",       desc: "ERCOT ancillary services keep the Texas grid stable when generation and load go out of balance. Learn what each service is, how they're procured, and what rising ancillary costs signal about imminent energy price spikes for your operations." },
