...
function generateFallback(question: string, props: Props): string {
  ...
  if (q.includes("threshold") || q.includes("escalation") || q.includes("trigger")) {
    return `Current escalation thresholds: ERCOT > $35/MWh (watch), ERCOT > $50/MWh (elevated), Temperature > 95°F (watch), Henry Hub > $3.00/MMBtu (watch). Current values: ERCOT $${price > 0 ? price.toFixed(2) : "N/A"}/MWh, Temperature ${temp > 0 ? temp.toFixed(0) + "°F" : "N/A"}, Henry Hub $${hh > 0 ? hh.toFixed(2) : "N/A"}/MMBtu.`;
  }
